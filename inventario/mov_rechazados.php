<!-- conexion -->
	<?php
		...
		$query="select a.id_mov, c.vehiculo, b.categoria, a.tipo_mov, a.cantidad, a.n_fac_orden, a.usuario, a.fecha, a.permiso, a.comentario from movimiento a, categoria b, vehiculo c where a.permiso='2' and c.id_vehi=a.vehiculo and b.id_categ=a.descripcion order by id_mov desc";
