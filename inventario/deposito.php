    ...
    <!-- Page Wrapper -->
			<div id="page-wrapper">
				...
				<section class="wrapperf alt style8">
					<div class="inner">
						<h2>DEPOSITO DE REPUESTOS</h2>
						<form action="mysqldeposito.php" method="POST" name="depositorepuesto">

							<h1>Vehiculo</h1>
							<a>NOTA: CAUCHOS Y BATERIAS INGRESAN COMO **VEHICULO GENERAL**</a>
								...
								<option value=''> Seleccione una Opcion</option>
									<?php 
									while($row=mysql_fetch_array($respuesta2))
									{
										echo "<option value='" . $row['id_categ'] . "'>" . $row['categoria'] . "</option>";
									}
									?>
								</select>
								...
								<br>
								<h1>Cantidad</h1>
								<input name="cantidad"type="text"   placeholder="LA CANTIDAD MINIMA ES 1" required='required'>
								<br>
								<h1>Número de Documento de Profit</h1>
								<input name="n_fac_orden" type="text" placeholder="ejemplo: 35890  Sin puntos o comas"required='required'>
								<br>
								<h1>Precio Unitario</h1>
								<input name="precio" type="text" placeholder="ejemplo: 3456321 Sin puntos o comas"required='required'>
								<br>
