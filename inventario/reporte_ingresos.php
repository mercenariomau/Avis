...
<?php
		...
		$query="select c.vehiculo, b.categoria, a.tipo_mov, a.cantidad, a.n_fac_orden, a.precio,a.usuario, a.fecha, a.comentario from movimiento a, categoria b, vehiculo c where a.tipo_mov='0' and c.id_vehi=a.vehiculo and b.id_categ=a.descripcion order by fecha desc";
											...
											<?php
												while($row=mysql_fetch_array($respuesta)){?>
													 <tr>
														...
														<td><a href='pdf/reportes/facturareporte.php?q=<?php echo $row['n_fac_orden'];?>' target='_blank'><?php echo $row['n_fac_orden'];?> </a>
														</td>
